...
function exp_PredSNAP2018_1rule1_eval_expression(context) {
    ...
    if (feature.properties) {
        return ((feature.properties['snapYes']  > 599) && (feature.properties['snapYes']  < 700));
    } else {
        return ((feature['snapYes']  > 599) && (feature['snapYes']  < 700));
    }
}
...
function exp_PredSNAP2018_1rule2_eval_expression(context) {
    ...
    if (feature.properties) {
        return ((feature.properties['snapYes']  > 499) && (feature.properties['snapYes']  < 600));
    } else {
        return ((feature['snapYes']  > 499) && (feature['snapYes']  < 600));
    }
}
